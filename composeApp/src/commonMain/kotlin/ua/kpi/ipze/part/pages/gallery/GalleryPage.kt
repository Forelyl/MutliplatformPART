package ua.kpi.ipze.part.pages.gallery
...
import mutliplatformpart.composeapp.generated.resources.change_key
import mutliplatformpart.composeapp.generated.resources.drawings
import mutliplatformpart.composeapp.generated.resources.image_frame_icon
import mutliplatformpart.composeapp.generated.resources.key_icon
import mutliplatformpart.composeapp.generated.resources.turtle
import org.jetbrains.compose.resources.painterResource
import ua.kpi.ipze.part.pages.gallery.fragments.ArtCard
import ua.kpi.ipze.part.providers.BasePageDataProvider
import ua.kpi.ipze.part.router.EditorPageData
import ua.kpi.ipze.part.router.LoginPageData
    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = localizedStringResource(Res.string.turtle, data.languageViewModel),
                    fontSize = 12.sp,
...
//                        })
                    ...
                    Icon(
                        painter = painterResource(Res.drawable.image_frame_icon),
...
//                        tint = if (selectedTab == 0) Color(0xFFE57373) else Color(0xffffffff),
                    ...
                    Text(
                        localizedStringResource(Res.string.drawings, data.languageViewModel),
...
//                }
                ...
                Column(
                    ...
                    Icon(
                        painter = painterResource(Res.drawable.key_icon),
                        contentDescription = null,
                        tint = Color(0xffffffff),
                        modifier = Modifier.size(24.dp)
                    )
                    Spacer(modifier = Modifier.height(4.dp))
                    Text(
                        localizedStringResource(Res.string.change_key, data.languageViewModel),
                        color = Color(0xffffffff),
                        fontSize = 12.sp
                    )
                }
            ...
            Box(
                ...
                IconButton(
                    onClick = {
                        data.nav.navigate(NewProjectPageData)
                    },
                ) {
                    Icon(
