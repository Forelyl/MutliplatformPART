package ua.kpi.ipze.part.pages.gallery.fragments
...
import mutliplatformpart.composeapp.generated.resources.check
        ...
        Column(
            ...
            if (!showMenu) Row(
                ...
                IconButton(
                    ...
                    Icon(
                        painter = painterResource(if (name == item.name) Res.drawable.close_x_icon else Res.drawable.check),
                        contentDescription = null,
                        tint = Color.White,
                        modifier = Modifier.size(20.dp)
                    )
