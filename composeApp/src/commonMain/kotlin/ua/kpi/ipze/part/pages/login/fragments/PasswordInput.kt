package ua.kpi.ipze.part.pages.login.fragments
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Surface(
            modifier = Modifier
                .fillMaxWidth()
                .pixelBorder(
                    borderWidth = 3.dp, outerColor = borderColor[0],
            ...
            Row(
                ...
                IconButton(
                    ...
                    Icon(
                        painter = painterResource(if (passwordVisible) Res.drawable.open_eye else Res.drawable.hidden_eye),
